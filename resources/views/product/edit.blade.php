...
<div class="container">
    ...
    <div class="panel panel-primary">
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-8">
                    <form method="post" action="{{ action( 'ProductController@update', $products->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea cols="5" rows="5" class="form-control" name="description" required> {{$products->description}}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="produced_on" value="{{$products->produced_on}}" required/>
                        </div>
